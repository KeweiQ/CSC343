...
CREATE VIEW alliance AS
	...
	WHERE er1.election_id = er2.election_id AND er1.party_id < er2.party_id AND (er1.id = 	er2.alliance_id OR er1.allience_id = er2.id OR er1.alliance_id = er2.alliance_id);
